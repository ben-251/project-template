...
rsq(laptop_test_pred_1, truth = Price, estimate = .pred, adj = TRUE)
...
rsq(laptop_test_pred_2, truth = Price, estimate = .pred, adj = TRUE)
...
rsq(laptop_test_pred_3, truth = Price, estimate = .pred, adj = TRUE)
...
rsq(laptop_test_pred_4, truth = Price, estimate = .pred, adj = TRUE)
...
rsq(laptop_test_pred_5, truth = Price, estimate = .pred, adj = TRUE)
...
rsq(laptop_test_pred_6, truth = Price, estimate = .pred, adj = TRUE)
...
rsq(laptop_test_pred_7, truth = Price, estimate = .pred, adj = TRUE)
...
rsq(laptop_test_pred_8, truth = Price, estimate = .pred, adj = TRUE)
...
rsq(laptop_test_pred_9, truth = Price, estimate = .pred, adj = TRUE)
...
rsq(laptop_test_pred_10, truth = Price, estimate = .pred, adj = TRUE)
...
```{r log-residual-comparison-b, eval=FALSE}

price_fit_10_aug <- augment(price_fit_10$fit)
ggplot(price_fit_10_aug, mapping = aes(x = .fitted, y = .resid)) +
