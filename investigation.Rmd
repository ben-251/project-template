...
#in this chunk I aim to gain more insight on the characteristics of the different laptop types to indicate if the existence of certain variables increase the likelihood of what laptop type the device is
...
#laptop_data_tidy <-laptop_data_tidy %>%
  #rename(,log_price_rupees = log_price_rupees)
...
#laptop_data_tidy <-laptop_data_tidy %>%
 # mutate(
        #log_price_gbp = log(round(exp(log_price_rupees) * 0.0094 , digits =2)),
        #price = round(exp(log_price_gbp),digits = 2)
