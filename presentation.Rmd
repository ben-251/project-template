...
$$
\widehat{logPrice} = 5.59 +  (0.0271 \times Ram) + (0.000857 \times SSD) + \dots
$$
---
## Numeric Variables
For every additional GB of Ram, the estimated log price increases on average by e^0.0271 log GBP

## Categorical
Each category also has a baseline:

The base line intercept has no meaning as a laptop can be of the base type or base company but a laptop cannot have 0 RAM

// check the estimates again
For:
- The log price increases by e^0.139 log pounds for Gaming Laptops relative to 2-in-1 convertibles
- The log price decreases by e^0.155 log pounds for Notebooks relative to 2-in-1 Convertibles
