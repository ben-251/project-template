...
$$
\widehat{logPrice} = 5.4774 +  (0.0266 \times Ram) + (0.000857 \times SSD) + \dots
$$
---
## Numeric Variables
For every additional GB of Ram,all else held constant, the estimated price increases on average by a factor of 1.027

For every additional GB of SSD, all else held constant, the estimated price increases on average by a factor of 1.0008
